 ...
 */
package spindle.exception;

import spindle.core.SpindleException;

public class EditorException extends SpindleException {
	...
	protected EditorException(String message, Throwable cause) {
		super(null, null, message, cause, (Object[]) null);
	}
