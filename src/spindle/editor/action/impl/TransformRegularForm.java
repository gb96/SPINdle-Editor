...
public class TransformRegularForm extends EditorAction {
	public static final String LABEL = "Regular form";
	private static final String TOOL_TIP = "Transform theory to regular form";
	private static final int ACCELERATOR = -1;
	private static final String ICON = "/spindle/resources/hand.gif";

	public TransformRegularForm() {
	...
	public void run() {
		...
		ScreenManager.getApp().transformTheoryToRegularForm();
	}
