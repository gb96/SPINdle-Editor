...
public class CloseAllTheories extends EditorAction {
	public static final String LABEL = "Close &all theories";
	private static final String TOOL_TIP = "Close all theories";
	private static final int ACCELERATOR = SWT.CTRL | 'A';
	private static final String ICON = "";

	public CloseAllTheories() {
