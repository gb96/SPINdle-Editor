...
public class SaveTheoryAs extends EditorAction {
	public static final String LABEL = "Save theory as...";
	private static final String TOOL_TIP = "Save theory to another file";
	...
	public void run() {
		...
		ScreenManager.getApp().saveTheoryAs();
	}
