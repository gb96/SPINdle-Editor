...
public class NewModeRule extends EditorAction {

	public static final String LABEL = "New mode rule";
	private static final String TOOL_TIP = "New mode rule";
	...
	public void run() {
		...
		ScreenManager.getApp().addModeRule();
	}
