...
public class TransformRemoveDefeater extends EditorAction {
	public static final String LABEL = "Remove defeaters";
	private static final String TOOL_TIP = "Transform: remove defeaters from theory";
	private static final int ACCELERATOR = -1;
	private static final String ICON = "/spindle/resources/grid_group-by.gif";

	public TransformRemoveDefeater() {
	...
	public void run() {
		...
		ScreenManager.getApp().transformRemoveDefeater();
	}
