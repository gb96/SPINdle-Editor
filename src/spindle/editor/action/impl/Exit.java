...
public class Exit extends EditorAction {
	...
	public static final String LABEL = "E&xit";
	private static final String TOOL_TIP = "Exit editor";
	private static final int ACCELERATOR = SWT.CTRL + 'X';
