...
public class PrintConclusions extends EditorAction {
	public static final String LABEL = "Print conclusions";
	private static final String TOOL_TIP = "Print conclusions";
	private static final int ACCELERATOR = -1;
	private static final String ICON = "/spindle/resources/print.gif";

	public PrintConclusions() {
	...
	public void run() {
		...
		ScreenManager.getApp().printConclusions();
	}
