...
public class PrintTheory extends EditorAction {
	public static final String LABEL = "Print theory";
	private static final String TOOL_TIP = "Print theory";
	...
	public void run() {
		...
		ScreenManager.getApp().printTheory();
	}
