...
public class SaveTheory extends EditorAction {
	public static final String LABEL = "Save theory";
	private static final String TOOL_TIP = "Save theory";
	private static final int ACCELERATOR = -1;
	private static final String ICON = "/spindle/resources/save.gif";
