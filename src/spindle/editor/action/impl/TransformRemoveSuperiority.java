...
public class TransformRemoveSuperiority extends EditorAction {
	public static final String LABEL = "Remove superiority relations";
	private static final String TOOL_TIP = "Transform: remove superiority relations from theory";
	private static final int ACCELERATOR = -1;
	private static final String ICON = "/spindle/resources/camcord.gif";

	public TransformRemoveSuperiority() {
	...
	public void run() {
		...
		ScreenManager.getApp().transformRemoveSuperiority();
	}
