...
public class IsAmbiguityPropagation extends EditorAction {
	public static final String LABEL = "Ambiguity propagation";
	private static final String TOOL_TIP = "Ambiguity propagation";
	private static final int ACCELERATOR = -1;
	private static final String ICON = "";

	public IsAmbiguityPropagation() {
	...
	public void run() {
		...
		ScreenManager.getApp().setAmbiguityPropagation(isChecked());
	}
