...
public class GetConclusions extends EditorAction {

	public static final String LABEL = "Generate conclusions";
	private static final String TOOL_TIP = "Generate conclusions";
	private static final int ACCELERATOR = -1;
	private static final String ICON = "/spindle/resources/preview.gif";
	...
	public void run() {
		...
		if (EditorConst.isDeploy) {
			ScreenManager.getApp().generateConclusionsWithTransformations();
		} else {
			ScreenManager.getApp().generateConclusions();
		}
	}
}
