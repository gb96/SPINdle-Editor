...
public class NewLiteralVariable extends EditorAction{
	public static final String LABEL = "New literal variable";
	private static final String TOOL_TIP = "New literal variable";
	private static final int ACCELERATOR = -1;
	private static final String ICON = "";

	public NewLiteralVariable() {
	...
	public void run() {
		...
		ScreenManager.getApp().addLiteralVariable();
	}
